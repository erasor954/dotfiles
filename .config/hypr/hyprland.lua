...
-- This is an example Hyprland config file mapped to Lua for Hyprland 0.55+.
...
-----------------------------
-- Using hl.env() properly exposes variables before the display server spins up
...
--- KEYBINDINGS ---
-------------------
-- Using the new Hyprland Lua binding system and layout dispatchers (hl.dsp)
...
-- Workspaces: leveraging Lua loops
for i = 1, 9 do
	-- Switch to workspace (uses the focus dispatcher)
	hl.bind(mainMod .. " + " .. i, hl.dsp.focus({ workspace = tostring(i) }))

	-- Move active window to workspace (uses window.move dispatcher)
